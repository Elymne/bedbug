...
class AppTextStyles {
  ...
  static final TextStyle textfield = const TextStyle(fontSize: 16, fontWeight: FontWeight.w100, color: AppColors.onLight);

  /// Métadonnées d'un contenu (sub, temps écoulé).
  static final TextStyle contentMeta = const TextStyle(fontSize: 12, fontWeight: FontWeight.w400, color: AppColors.disabled);

  /// Titre d'un contenu.
  static final TextStyle contentTitle = const TextStyle(fontSize: 14, fontWeight: FontWeight.w600, color: AppColors.onLight);
